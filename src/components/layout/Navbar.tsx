...
/**
 * Navbar
 * Floating glassmorphic top navigation bar with active section indicator,
 * spring layoutId pill, and dark mode toggle.
 */
            ...
            return (
              ...
              >
                ...
                {isActive && (
                  <motion.span
                    layoutId="nav-pill"
                    className="absolute inset-0 rounded-xl border bg-[#b8860b]/8 border-[#b8860b]/30 dark:bg-[#d4af37]/10 dark:border-[#d4af37]/30"
